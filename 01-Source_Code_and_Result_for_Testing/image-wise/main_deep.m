...
load cnn2;
load cnn_deep;
result_dir = 'E:\研究生资料\我的论文及相关程序\小论文\小论文3\论文对应的三级网络程序及实验结果\1-从新训练的网络\数据集测试结果\方式1 - 第二次训练\result';
addpath('E:\研究生资料\我的论文及相关程序\小论文\小论文3\论文对应的三级网络程序及实验结果\test_ImageData');
