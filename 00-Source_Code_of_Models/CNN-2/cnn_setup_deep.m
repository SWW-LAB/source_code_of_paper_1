function net = cnn_setup_deep(net, x, y)  
    ...
    for layer_n = 1 : numel(net.conv_layer)   
        if strcmp(net.conv_layer{layer_n}.type, 'c')
            ...
            for j = 1 : net.conv_layer{layer_n}.outputmaps
    ...
    for layer_n = 1 :full_n
        ...
        net.full_layer{layer_n}.w = (rand(net.full_layer{layer_n}.neurons, fvnum) - 0.5) * 2 * sqrt(6 / (net.full_layer{layer_n}.neurons + fvnum));
