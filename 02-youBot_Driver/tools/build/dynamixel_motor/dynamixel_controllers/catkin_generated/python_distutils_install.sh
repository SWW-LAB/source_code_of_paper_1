...
echo_and_run cd "/home/chao/tools/src/dynamixel_motor/dynamixel_controllers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/chao/tools/src/dynamixel_motor/dynamixel_controllers/setup.py" \
    build --build-base "/home/chao/tools/build/dynamixel_motor/dynamixel_controllers" \
    install \
    $DESTDIR_ARG \
