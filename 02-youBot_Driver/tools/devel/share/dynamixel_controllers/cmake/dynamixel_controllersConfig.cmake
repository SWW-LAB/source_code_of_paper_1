...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_controllers_SOURCE_PREFIX /home/chao/tools/src/dynamixel_motor/dynamixel_controllers)
  set(dynamixel_controllers_DEVEL_PREFIX /home/chao/tools/devel)
  ...
  set(dynamixel_controllers_INSTALL_PREFIX /home/chao/tools/install)
...
if(NOT "/home/chao/tools/devel/include " STREQUAL " ")
  set(dynamixel_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/chao/tools/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chao/tools/src/dynamixel_motor/dynamixel_controllers/${idir}'.  Ask the maintainer 'Antons Rebguns <arebgun@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chao/tools/devel/lib;/home/chao/catkin_ws_action/devel/lib;/opt/ros/indigo/lib)
