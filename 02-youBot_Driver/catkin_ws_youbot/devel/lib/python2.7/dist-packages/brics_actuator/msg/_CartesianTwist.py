...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.translation.x, _x.translation.y, _x.translation.z))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.rotation.x, _x.rotation.y, _x.rotation.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.translation.x, _x.translation.y, _x.translation.z,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.rotation.x, _x.rotation.y, _x.rotation.z,) = _struct_3d.unpack(str[start:end])
