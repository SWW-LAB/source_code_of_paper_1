...
if("TRUE" STREQUAL "TRUE")
  set(realsense_camera_SOURCE_PREFIX /home/chao/catkin_ws_youbot/src/realsense_camera)
  set(realsense_camera_DEVEL_PREFIX /home/chao/catkin_ws_youbot/devel)
  ...
  set(realsense_camera_INSTALL_PREFIX /home/chao/catkin_ws_youbot/install)
...
if(NOT "/home/chao/catkin_ws_youbot/devel/include " STREQUAL " ")
  set(realsense_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/chao/catkin_ws_youbot/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'DD <dd@dorabot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chao/catkin_ws_youbot/src/realsense_camera/${idir}'.  Ask the maintainer 'DD <dd@dorabot.com>' to fix it.")
    endif()
...
set(realsense_camera_EXPORTED_TARGETS "realsense_camera_gencfg;realsense_camera_generate_messages_cpp;realsense_camera_generate_messages_lisp;realsense_camera_generate_messages_py")
