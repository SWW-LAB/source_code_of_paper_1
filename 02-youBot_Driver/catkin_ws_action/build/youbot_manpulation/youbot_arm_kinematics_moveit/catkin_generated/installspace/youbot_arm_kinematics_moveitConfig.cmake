...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'youbot_arm_kinematics_moveit' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chao/catkin_ws_action/install/${idir}'.  Ask the maintainer 'Sven Schneider <sven.schneider@h-brs.de>' to fix it.")
    endif()
