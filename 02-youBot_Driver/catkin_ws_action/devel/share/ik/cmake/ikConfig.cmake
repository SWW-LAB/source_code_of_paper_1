...
if(NOT "/home/chao/catkin_ws_action/devel/include " STREQUAL " ")
  set(ik_INCLUDE_DIRS "")
  set(_include_dirs "/home/chao/catkin_ws_action/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chao/catkin_ws_action/src/ik/${idir}'.  Ask the maintainer 'zc <zc@todo.todo>' to fix it.")
    endif()
