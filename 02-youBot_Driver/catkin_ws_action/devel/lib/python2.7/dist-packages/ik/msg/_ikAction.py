...
"""autogenerated by genpy from ik/ikAction.msg. Do not edit."""
import sys
...
class ikAction(genpy.Message):
  _md5sum = "a2ead7d66f5e3cde0cc05003b8ec76df"
  _type = "ik/ikAction"
...
"""
  ...
  _slot_types = ['ik/ikActionGoal','ik/ikActionResult','ik/ikActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = ik.msg.ikActionGoal()
      if self.action_result is None:
        self.action_result = ik.msg.ikActionResult()
      if self.action_feedback is None:
        self.action_feedback = ik.msg.ikActionFeedback()
    else:
      self.action_goal = ik.msg.ikActionGoal()
      self.action_result = ik.msg.ikActionResult()
      self.action_feedback = ik.msg.ikActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.jointresult)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_result.result.jointresult))
      _x = self
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.jointfeedback)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.jointfeedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_result.result.jointresult = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_feedback.feedback.jointfeedback = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_result.result.jointresult.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      _x = self.action_feedback.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_feedback.feedback.jointfeedback.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_result.result.jointresult = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      ...
      self.action_feedback.feedback.jointfeedback = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
