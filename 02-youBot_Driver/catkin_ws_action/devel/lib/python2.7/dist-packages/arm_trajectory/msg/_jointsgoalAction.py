...
"""autogenerated by genpy from arm_trajectory/jointsgoalAction.msg. Do not edit."""
import sys
...
class jointsgoalAction(genpy.Message):
  _md5sum = "83428fd118881c6694ee772724e8021b"
  _type = "arm_trajectory/jointsgoalAction"
...
"""
  ...
  _slot_types = ['arm_trajectory/jointsgoalActionGoal','arm_trajectory/jointsgoalActionResult','arm_trajectory/jointsgoalActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(jointsgoalAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = arm_trajectory.msg.jointsgoalActionGoal()
      if self.action_result is None:
        self.action_result = arm_trajectory.msg.jointsgoalActionResult()
      if self.action_feedback is None:
        self.action_feedback = arm_trajectory.msg.jointsgoalActionFeedback()
    else:
      self.action_goal = arm_trajectory.msg.jointsgoalActionGoal()
      self.action_result = arm_trajectory.msg.jointsgoalActionResult()
      self.action_feedback = arm_trajectory.msg.jointsgoalActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.jointsgoal)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.jointsgoal))
      _x = self
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.jointsgoalresult)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_result.result.jointsgoalresult))
      _x = self
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_feedback.feedback.jointsgoalfeedback)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.jointsgoalfeedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.jointsgoal = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_result.result.jointsgoalresult = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.action_feedback.feedback.jointsgoalfeedback = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_goal.goal.jointsgoal.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      _x = self.action_result.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_result.result.jointsgoalresult.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      _x = self.action_feedback.header.frame_id
      length = len(_x)
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_feedback.feedback.jointsgoalfeedback.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.jointsgoal = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      ...
      self.action_result.result.jointsgoalresult = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      ...
      self.action_feedback.feedback.jointsgoalfeedback = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
